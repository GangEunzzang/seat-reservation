...
from api.v1.user.user_response import UserResponse
...
from app.user.domain.user_register_request import UserRegisterRequest as DomainUserRegisterRequest, UserRegisterRequest
